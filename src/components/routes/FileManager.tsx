...
export function FileManager() {
  ...
  const handlePasswordShare = (fileId: string, fileName: string) => {
  ...
  return (
    <div className="flex flex-col h-screen bg-slate-50 dark:bg-slate-900 transition-colors duration-200">
      <Header
        ...
        setIsDownloadListOpen={setIsDownloadListOpen}
                    ...
                    {filteredFiles.map((update) => (
                      ...
                      >
                        <FileCard
                          ...
                          onPasswordShare={handlePasswordShare}
